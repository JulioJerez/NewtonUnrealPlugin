...
class FNewtonModelPhysicsTreeItemLoop : public FNewtonModelPhysicsTreeItem
{
	public:
	NEWTON_ADD_RTTI(FNewtonModelPhysicsTreeItemLoop, FNewtonModelPhysicsTreeItem)

	FNewtonModelPhysicsTreeItemLoop(const FNewtonModelPhysicsTreeItemLoop& src);
	FNewtonModelPhysicsTreeItemLoop(TSharedPtr<FNewtonModelPhysicsTreeItem> parentNode, TObjectPtr<UNewtonLink> modelNode, FNewtonModelEditor* const editor);
