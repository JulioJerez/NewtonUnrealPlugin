...
class FNewtonModelPhysicsTreeItemShapeBox : public FNewtonModelPhysicsTreeItemShape
{
	...
	FNewtonModelPhysicsTreeItemShapeBox(TSharedPtr<FNewtonModelPhysicsTreeItem> parentNode, TObjectPtr<UNewtonLink> modelNode, FNewtonModelEditor* const editor);
