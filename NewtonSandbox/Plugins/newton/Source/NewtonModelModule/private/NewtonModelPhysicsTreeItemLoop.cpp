...
FNewtonModelPhysicsTreeItemLoop::FNewtonModelPhysicsTreeItemLoop(const FNewtonModelPhysicsTreeItemLoop& src)
	:FNewtonModelPhysicsTreeItem(src)
{
}

FNewtonModelPhysicsTreeItemLoop::FNewtonModelPhysicsTreeItemLoop(TSharedPtr<FNewtonModelPhysicsTreeItem> parentNode, TObjectPtr<UNewtonLink> modelNode, FNewtonModelEditor* const editor)
	:FNewtonModelPhysicsTreeItem(parentNode, modelNode, editor)
{
}

FName FNewtonModelPhysicsTreeItemLoop::BrushName() const
{
	return TEXT("loopIcon.png");
}

FNewtonModelPhysicsTreeItem* FNewtonModelPhysicsTreeItemLoop::Clone() const
{
	return new FNewtonModelPhysicsTreeItemLoop(*this);
}

void FNewtonModelPhysicsTreeItemLoop::DrawCone(FPrimitiveDrawInterface* const pdi, const FMatrix& matrix, const FColor& color) const
{
...
bool FNewtonModelPhysicsTreeItemLoop::ShouldDrawWidget() const
{
...
bool FNewtonModelPhysicsTreeItemLoop::HaveSelection() const
{
	const UNewtonLink* const node = Cast<UNewtonLink>(m_node);
	check(node);
	return node->ShowDebug;
