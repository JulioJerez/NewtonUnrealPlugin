...
FNewtonModelPhysicsTreeItemJointLoopEffector6dof::FNewtonModelPhysicsTreeItemJointLoopEffector6dof(const FNewtonModelPhysicsTreeItemJointLoopEffector6dof& src)
	:FNewtonModelPhysicsTreeItemJointLoop(src)
{
}

FNewtonModelPhysicsTreeItemJointLoopEffector6dof::FNewtonModelPhysicsTreeItemJointLoopEffector6dof(TSharedPtr<FNewtonModelPhysicsTreeItem> parentNode, TObjectPtr<UNewtonLink> modelNode, FNewtonModelEditor* const editor)
	:FNewtonModelPhysicsTreeItemJointLoop(parentNode, modelNode, editor)
{
}

FNewtonModelPhysicsTreeItem* FNewtonModelPhysicsTreeItemJointLoopEffector6dof::Clone() const
{
	return new FNewtonModelPhysicsTreeItemJointLoopEffector6dof(*this);
}


void FNewtonModelPhysicsTreeItemJointLoopEffector6dof::DebugDraw(const FSceneView* const view, FViewport* const viewport, FPrimitiveDrawInterface* const pdi) const
{
...
void FNewtonModelPhysicsTreeItemJointLoopEffector6dof::OnPropertyChange(const FPropertyChangedEvent& event)
{
