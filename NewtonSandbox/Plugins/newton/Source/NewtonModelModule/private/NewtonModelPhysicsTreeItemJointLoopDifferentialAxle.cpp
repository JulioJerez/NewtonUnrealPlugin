...
FNewtonModelPhysicsTreeItemJointLoopDifferentialAxle::FNewtonModelPhysicsTreeItemJointLoopDifferentialAxle(const FNewtonModelPhysicsTreeItemJointLoopDifferentialAxle& src)
	:FNewtonModelPhysicsTreeItemJointLoop(src)
{
}

FNewtonModelPhysicsTreeItemJointLoopDifferentialAxle::FNewtonModelPhysicsTreeItemJointLoopDifferentialAxle(TSharedPtr<FNewtonModelPhysicsTreeItem> parentNode, TObjectPtr<UNewtonLink> modelNode, FNewtonModelEditor* const editor)
	:FNewtonModelPhysicsTreeItemJointLoop(parentNode, modelNode, editor)
{
}

FNewtonModelPhysicsTreeItem* FNewtonModelPhysicsTreeItemJointLoopDifferentialAxle::Clone() const
{
	return new FNewtonModelPhysicsTreeItemJointLoopDifferentialAxle(*this);
}


void FNewtonModelPhysicsTreeItemJointLoopDifferentialAxle::DebugDraw(const FSceneView* const view, FViewport* const viewport, FPrimitiveDrawInterface* const pdi) const
{
...
void FNewtonModelPhysicsTreeItemJointLoopDifferentialAxle::OnPropertyChange(const FPropertyChangedEvent& event)
{
