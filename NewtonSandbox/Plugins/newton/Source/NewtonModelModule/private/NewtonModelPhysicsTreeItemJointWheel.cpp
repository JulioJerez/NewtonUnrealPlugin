...
FNewtonModelPhysicsTreeItemJointWheel::FNewtonModelPhysicsTreeItemJointWheel(const FNewtonModelPhysicsTreeItemJointWheel& src)
	:FNewtonModelPhysicsTreeItemJoint(src)
{
}

FNewtonModelPhysicsTreeItemJointWheel::FNewtonModelPhysicsTreeItemJointWheel(TSharedPtr<FNewtonModelPhysicsTreeItem> parentNode, TObjectPtr<UNewtonLink> modelNode, FNewtonModelEditor* const editor)
	:FNewtonModelPhysicsTreeItemJoint(parentNode, modelNode, editor)
{
}

FNewtonModelPhysicsTreeItem* FNewtonModelPhysicsTreeItemJointWheel::Clone() const
{
	return new FNewtonModelPhysicsTreeItemJointWheel(*this);
}
...
{
	const UNewtonLinkJointWheel* const jointNode = Cast<UNewtonLinkJointWheel>(m_node);
	check(jointNode);
