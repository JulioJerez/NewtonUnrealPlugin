...
#include "NewtonLinkJointLoop6dofEffector.generated.h"

/**
 * 
 */
UCLASS()
class NEWTONRUNTIMEMODULE_API UNewtonLinkJointLoop6dofEffector : public UNewtonLinkJointLoop
{
	GENERATED_BODY()

	public:
	UNewtonLinkJointLoop6dofEffector();
