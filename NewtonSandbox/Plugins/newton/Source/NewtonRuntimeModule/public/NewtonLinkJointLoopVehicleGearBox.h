...
#include "NewtonLinkJointLoopVehicleGearBox.generated.h"

/**
 * 
 */
UCLASS()
class NEWTONRUNTIMEMODULE_API UNewtonLinkJointLoopVehicleGearBox : public UNewtonLinkJointLoop
{
	GENERATED_BODY()

	public:
	UNewtonLinkJointLoopVehicleGearBox();
