...
#include "NewtonLinkJointLoopVehicleTireAxle.generated.h"

/**
 * 
 */
UCLASS()
class NEWTONRUNTIMEMODULE_API UNewtonLinkJointLoopVehicleTireAxle : public UNewtonLinkJointLoop
{
	GENERATED_BODY()

	public:
	UNewtonLinkJointLoopVehicleTireAxle();
