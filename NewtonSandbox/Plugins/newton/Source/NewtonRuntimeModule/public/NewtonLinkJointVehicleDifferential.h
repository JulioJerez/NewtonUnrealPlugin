...
#include "NewtonLinkJointVehicleDifferential.generated.h"

/**
 * 
 */
UCLASS()
class NEWTONRUNTIMEMODULE_API UNewtonLinkJointVehicleDifferential : public UNewtonLinkJoint
{
	GENERATED_BODY()

	public:
	UNewtonLinkJointVehicleDifferential();
