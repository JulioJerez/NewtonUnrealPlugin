...
#include "NewtonLinkJointDifferential.generated.h"

/**
 * 
 */
UCLASS()
class NEWTONRUNTIMEMODULE_API UNewtonLinkJointDifferential : public UNewtonLinkJoint
{
	GENERATED_BODY()

	public:
	UNewtonLinkJointDifferential();
