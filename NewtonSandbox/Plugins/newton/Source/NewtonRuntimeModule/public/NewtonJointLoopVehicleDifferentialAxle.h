...
#include "NewtonJointLoopVehicleDifferentialAxle.generated.h"

UCLASS(ClassGroup = NewtonJoints, meta = (BlueprintSpawnableComponent))
class UNewtonJointLoopVehicleDifferentialAxle : public UNewtonJointLoop
{
	GENERATED_BODY()
	
	public:
	// Sets default values for this component's properties
	UNewtonJointLoopVehicleDifferentialAxle();
