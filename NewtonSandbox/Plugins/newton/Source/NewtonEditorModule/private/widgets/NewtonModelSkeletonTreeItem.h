...
class FNewtonModelSkeletonTreeItem : public ISkeletonTreeItem
{
public:
	SKELETON_TREE_ITEM_TYPE(FNewtonModelSkeletonTreeItem, ISkeletonTreeItem)

	friend class FSkeletonTreeBuilder;

	FNewtonModelSkeletonTreeItem(const TSharedRef<class ISkeletonTree>& InSkeletonTree);
