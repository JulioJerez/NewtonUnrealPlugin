...
//class FNewtonModelPhysicsTreeEditableSkeleton: public FGCObject, public TSharedFromThis<FNewtonModelPhysicsTreeEditableSkeleton>
class FNewtonModelPhysicsTreeEditableSkeleton : public TSharedFromThis<FNewtonModelPhysicsTreeEditableSkeleton>
{
	public:

	FNewtonModelPhysicsTreeEditableSkeleton(UNewtonModelAcyclicGraph* const skeleton);
	virtual ~FNewtonModelPhysicsTreeEditableSkeleton();
#if 0
	...
	*/
	...
	TSharedRef<FNewtonModelPhysicsTree> CreateSkeletonTree(const FNewtonModelPhysicsTreeArgs& args);


	/** The skeleton we are editing */
	TObjectPtr<UNewtonModelAcyclicGraph> Skeleton;
