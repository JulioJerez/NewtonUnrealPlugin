...
class FNewtonModelPhysicsTreeItemBody : public FNewtonModelPhysicsTreeItem
{
	...
	FNewtonModelPhysicsTreeItemBody(TSharedPtr<FNewtonModelPhysicsTreeItem> parentNode, TObjectPtr<UNewtonLink> modelNode);
...
class FNewtonModelPhysicsTreeItemBodyRoot : public FNewtonModelPhysicsTreeItemBody
{
	...
	FNewtonModelPhysicsTreeItemBodyRoot(TSharedPtr<FNewtonModelPhysicsTreeItem> parentNode, TObjectPtr<UNewtonLink> modelNode);
	virtual FNewtonModelPhysicsTreeItem* Clone() const override;
};